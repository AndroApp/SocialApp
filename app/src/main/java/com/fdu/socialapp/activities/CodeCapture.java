...
import com.fdu.socialapp.decoding.CaptureActivityHandler;
import com.fdu.socialapp.custom.ViewfinderView;
import com.fdu.socialapp.decoding.InactivityTimer;
import com.fdu.socialapp.decoding.RGBLuminanceSource;
...
public class CodeCapture extends Activity implements Callback, View.OnClickListener {
    ...
    private void onResultHandler(String resultString, Bitmap bitmap){
        if(TextUtils.isEmpty(resultString)){
            Toast.makeText(CodeCapture.this, "Scan failed!", Toast.LENGTH_SHORT).show();
            return;
        }
